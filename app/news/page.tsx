    ...
    <main>
      <section className="bg-primary py-24 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <span className="section-label text-accent/70">Stay Informed</span>
          ...
          <p className="text-white/65 font-light text-[1.0625rem] max-w-2xl leading-[1.85]">
            The latest updates, decisions, and notices from family leadership
            and the Umu Egbuke community.
          </p>
        </div>
      </section>
